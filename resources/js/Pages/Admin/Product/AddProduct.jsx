...
// Card wrapper style — overflow is intentionally NOT "hidden" here so that
// absolutely-positioned children (like CustomSelect dropdowns) aren't clipped.
// The header still gets its own top corner radius so there's no visual seam.
const cardStyle = {
  backgroundColor: tokens.background,
  border: `1px solid ${tokens.border}`,
  borderRadius: tokens.radius,
...
const AddProduct = () => {
  ...
  const [activeUrl, setActiveUrl] = useState("/admin/products/add");
            ...
            <div style={{ display: "flex", gap: "0.75rem" }}>
              ...
              <button
                ...
                style={{
                  ...
                  cursor: "pointer", opacity: saveBtnHovered ? 0.9 : 1,
                  ...
                  <div style={{ padding: "1.5rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onBlur={(e) => { if (!errors.name) e.target.style.borderColor = tokens.border; }}
                      />
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onFocus={(e) => { if (!errors.description) e.target.style.borderColor = tokens.foreground; }}
                        onBlur={(e) => { if (!errors.description) e.target.style.borderColor = tokens.border; }}
                      />
                    ...
                    <div>
                      ...
                      <CustomSelect
                        ...
                        onChange={(val) => { setForm((prev) => ({ ...prev, categoryId: val })); setTouched((prev) => ({ ...prev, categoryId: true })); }}
                  ...
                  <div style={{ padding: "1.5rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
                      <div>
                        ...
                        <input
                          ...
                          value={form.price} onChange={handleChange("price")} onBlur={handleBlur("price")}
                          placeholder="0.00"
                          style={{ ...inputStyle, borderColor: errors.price ? tokens.destructive : tokens.border }}
                          onFocus={(e) => { if (!errors.price) e.target.style.borderColor = tokens.foreground; }}
                          onBlur={(e) => { if (!errors.price) e.target.style.borderColor = tokens.border; }}
                        />
                      ...
                      <div>
                        ...
                        <input
                          id="discountAmount" type="number" step="0.01" min="0"
                          value={form.discountAmount} onChange={handleChange("discountAmount")}
                          placeholder="0.00"
                          style={inputStyle}
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
                      <div>
                        ...
                        <input
                          id="sku" type="text" value={form.sku}
                          onChange={handleChange("sku")} onBlur={handleBlur("sku")}
                          placeholder="e.g. DRESS-001"
                          style={{ ...inputStyle, borderColor: errors.sku ? tokens.destructive : tokens.border }}
                          onFocus={(e) => { if (!errors.sku) e.target.style.borderColor = tokens.foreground; }}
                          onBlur={(e) => { if (!errors.sku) e.target.style.borderColor = tokens.border; }}
                        />
                      ...
                      <div>
                        ...
                        <input
                          id="stockQuantity" type="number" min="0"
                          value={form.stockQuantity} onChange={handleChange("stockQuantity")}
                          placeholder="0"
                          style={inputStyle}
                          onFocus={(e) => (e.target.style.borderColor = tokens.foreground)}
                          onBlur={(e) => (e.target.style.borderColor = tokens.border)}
                      ...
                      <label style={{ display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer", fontSize: "0.875rem", color: tokens.foreground }}>
                        <div
                          ...
                          style={{
                            ...
                            border: form.featured ? `1px solid ${tokens.foreground}` : `1px solid ${tokens.border}`,
                            backgroundColor: form.featured ? tokens.foreground : "transparent",
                ...
                <div style={{ ...cardStyle, overflow: "hidden" }}>
                  ...
                  <div style={{ padding: "1.5rem" }}>
                    ...
                    <div
                      ...
                      onDrop={handleDrop}
                      style={{
                        border: `2px dashed ${isDragging ? tokens.foreground : tokens.border}`,
                        borderRadius: tokens.radius,
                        padding: "2rem",
                        textAlign: "center",
                        cursor: "pointer",
                        backgroundColor: isDragging ? tokens.secondary : "transparent",
                    ...
                    >
                      <input
                        ...
                        style={{ display: "none" }}
                      />
                      <div style={{ color: tokens.mutedForeground, marginBottom: "0.75rem" }}>
                        <IconUpload />
                      </div>
                      <p style={{ fontSize: "0.875rem", fontWeight: 500, color: tokens.foreground, margin: "0 0 0.25rem" }}>
                    ...
                    {imagePreviews.length > 0 && (
                      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(100px, 1fr))", gap: "0.75rem" }}>
                        {imagePreviews.map((preview, index) => (
                          <div key={index} style={{ position: "relative", borderRadius: tokens.radius, overflow: "hidden", backgroundColor: tokens.secondary, aspectRatio: "3/4" }}>
                            ...
                            <button
                              ...
                              style={{
                                ...
                                border: "none", backgroundColor: "rgba(0,0,0,0.5)", color: "#ffffff",
                    ...
                    {imagePreviews.length === 0 && (
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", color: tokens.mutedForeground }}>
                        <IconImage />
                      </div>
                    )}
                  </div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr auto", gap: "0.5rem", alignItems: "end" }}>
                      <div>
                        ...
                        <CustomSelect
                          ...
                          onChange={(val) => setNewVariant((prev) => ({ ...prev, size: val }))}
                          options={sizeOptions}
                          placeholder="Size"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          type="number" min="0" value={newVariant.stockQuantity}
                      ...
                      <button
                        ...
                        style={{
                          ...
                          width: "40px", height: "40px", borderRadius: tokens.radius,
                          border: `1px solid ${tokens.border}`,
                          backgroundColor: addVariantBtnHovered ? tokens.secondary : tokens.background,
                          color: tokens.foreground, cursor: "pointer",
                          transition: "background-color 0.15s ease",
                        }}
                        onMouseEnter={() => setAddVariantBtnHovered(true)}
                        onMouseLeave={() => setAddVariantBtnHovered(false)}
                      >
                        <IconPlus />
                      </button>
                    </div>
                        ...
                        {variants.map((variant) => (
                          <div
                            ...
                            style={{
                              ...
                              padding: "0.625rem 0.75rem", borderRadius: tokens.radius,
                              backgroundColor: tokens.secondary, border: `1px solid ${tokens.border}`,
                              fontSize: "0.8125rem",
                            }}
                          >
                            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                              <span style={{ fontWeight: 500, color: tokens.foreground }}>
                              ...
                              <span style={{ color: tokens.mutedForeground, marginLeft: "0.5rem" }}>
                            ...
                            <button
                              ...
                              style={{
                                ...
                                color: tokens.mutedForeground, padding: "4px", borderRadius: tokens.radius,
                                display: "flex", alignItems: "center",
                                transition: "color 0.15s ease",
                              }}
                              onMouseEnter={(e) => (e.currentTarget.style.color = tokens.destructive)}
