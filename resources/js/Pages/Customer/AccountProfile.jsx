                      ...
                      <div style={{ 
                        ...
                        <button
                          ...
                          style={{
                            ...
                            backgroundColor: cancelBtnHovered ? "#ef3144" : "transparent",
                            color: cancelBtnHovered ? "#fff" : tokens.foreground,
                            cursor: "pointer",
                    ...
                    <form onSubmit={handlePasswordSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: tokens.radius,
                          border: `1px solid #f6aab2`,
                          backgroundColor: updatePwdBtnHovered ? "#f6aab2" : "transparent",
                          color: updatePwdBtnHovered ? "#fff" : tokens.foreground,
